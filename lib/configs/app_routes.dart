...
class AppRoutes {
  ...
  static Page _homeScreenRoutePageBuilder(
    ...
    if (state.extra != null && state.extra is User) {
      ...
      user = User(
        id: 002,
        name: "Refi FIrmansyah",
        userName: "Refi",
        email: "2006010@itg.ac.id",
        profileImage:
            "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Hindvir_Gaulhammer_Fest_111008_01_C.jpg/200px-Hindvir_Gaulhammer_Fest_111008_01_C.jpg",
